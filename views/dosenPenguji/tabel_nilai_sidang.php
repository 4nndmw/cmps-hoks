                        ...
                        <li class="sidebar-item active has-sub">
                            ...
                            <ul class="submenu active">
                                <li class="submenu-item active">
                                    <a href="#">Tabel Input Nilai Sidang</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="form-element-input-group.html">Tampil Nilai Mahasiswa </a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="form-element-input-group.html">Lihat Jadwal Sidang </a>
                                </li>
                            </ul>
                        </li>
                        <a href="#" class='sidebar-link sidebar-item  has-sub'>
                            <i>
                                << </i>
                                    <span>LogOut </span>
                        </a>
